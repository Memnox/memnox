...
- 3390bd8: `memnox login` sent people to a page that does not exist.
...
- 7078065: A self-taught skill is held on the machine that wrote it, and nobody is sitting at that
  machine.
